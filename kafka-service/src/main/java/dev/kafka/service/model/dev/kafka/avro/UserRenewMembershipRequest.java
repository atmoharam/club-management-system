...
public class UserRenewMembershipRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<UserRenewMembershipRequest> ENCODER =
      new BinaryMessageEncoder<UserRenewMembershipRequest>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<UserRenewMembershipRequest> DECODER =
      new BinaryMessageDecoder<UserRenewMembershipRequest>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<UserRenewMembershipRequest> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<UserRenewMembershipRequest> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<UserRenewMembershipRequest> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<UserRenewMembershipRequest>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this UserRenewMembershipRequest to a ByteBuffer.
  ...
  /**
   * Deserializes a UserRenewMembershipRequest from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a UserRenewMembershipRequest instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static UserRenewMembershipRequest fromByteBuffer(
   ...
   */
  public UserRenewMembershipRequest() {}
  ...
  /**
   * Creates a new UserRenewMembershipRequest RecordBuilder by copying an existing Builder.
  ...
  /**
   * Creates a new UserRenewMembershipRequest RecordBuilder by copying an existing UserRenewMembershipRequest instance.
  ...
  /**
   * RecordBuilder for UserRenewMembershipRequest instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserRenewMembershipRequest>
    ...
    public UserRenewMembershipRequest build() {
      try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<UserRenewMembershipRequest>
    WRITER$ = (org.apache.avro.io.DatumWriter<UserRenewMembershipRequest>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<UserRenewMembershipRequest>
    READER$ = (org.apache.avro.io.DatumReader<UserRenewMembershipRequest>)MODEL$.createDatumReader(SCHEMA$);
